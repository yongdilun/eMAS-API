  ...
  return (
    <div className="flex h-full w-full">
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="p-8 border-b border-gray-200 dark:border-gray-700/50 flex-shrink-0">
          <PageHeader title="Jobs" subtitle="Manage production jobs.">
            <button
              onClick={() => setIsFilterOpen(true)}
              className="relative flex items-center gap-2 h-10 px-4 bg-transparent border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-white text-sm font-bold rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <Link
              to="/scheduling"
              className="flex items-center gap-2 h-10 px-4 bg-transparent border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 text-sm font-semibold rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 h-10 px-3 bg-transparent border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 text-xs font-semibold rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            >
        ...
        <div className="flex-1 flex overflow-hidden p-6">
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400 gap-3">
                <span className="w-5 h-5 border-2 border-gray-300 border-t-primary rounded-full animate-spin" />
                Loading jobs…
              </div>
            ) : jobs.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-64 text-gray-500 dark:text-gray-400 gap-3">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <span className="font-bold text-sm text-gray-900 dark:text-white truncate">{jobId}</span>
