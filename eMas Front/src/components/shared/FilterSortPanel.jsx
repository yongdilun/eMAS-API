...
const FilterSortPanel = ({
 ...
 {/* Panel */}
 <div
 className={`fixed top-0 right-0 h-full z-40 w-80 bg-canvas border-l border-hairline -2xl flex flex-col transition-transform duration-300 ${
 ...
 className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-pill text-button transition-colors ${
 sortDir === d
