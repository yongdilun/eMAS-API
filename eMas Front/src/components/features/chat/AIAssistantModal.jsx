...
const AIAssistantModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        ref={containerRef}
        className="pointer-events-auto absolute rounded-2xl overflow-hidden shadow-2xl border border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-[#111618] flex flex-col resize-container"
        style={{
          left: position.x,
          top: position.y,
          width: size.width,
