                    ...
                    <tbody>
                        {shortages.map((s, idx) => {
                            ...
                            return (
                                <tr
                                    key={`${entityId}-${idx}`}
                                    className={`border-t border-hairline ${isFocused ? 'bg-amber-50 dark:bg-amber-900/20' : ''
                                        }`}
                                >
                                    ...
                                    <td className="px-3 py-2">
                                        <span className={`px-2 py-0.5 rounded text-[10px] ${s.all_step_materials_feasible === false
