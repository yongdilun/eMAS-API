...
from agent.toolgen import fetch_openapi_spec, render_tools_md, tools_from_openapi, write_tools_md_and_meta
...
async def generate():
    ...
    async with AsyncSessionLocal() as db_session:
        result = await write_tools_md_and_meta(db_session, tools=tools, tools_md_path=TOOLS_MD_PATH, replace_db=True)
